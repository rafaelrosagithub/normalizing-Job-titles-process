package com.rafael.api.normalizer.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.rafael.api.normalizer.controller.*.*(..))")
    ...
    @Before("execution(* com.rafael.api.normalizer.service.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.rafael.api.normalizer.controller.*.*(..))", returning = "result")
    ...
    @AfterReturning(pointcut = "execution(* com.rafael.api.normalizer.service.*.*(..))", returning = "result")
